...
import {getCoupons, createCoupons, createUserCoupons, updateCoupons} from "../controllers/couponsController";
 ...
 *               type: object
 */
router.get('/get-all-coupons', autoMiddleware, getCoupons);
 ...
 */
router.get('/get-one-coupons/:couponID', autoMiddleware, getCoupons);
 ...
 */
router.get('/get-user-coupons/:userID', autoMiddleware, getCoupons);
 ...
 */
router.post('/post-coupons', autoMiddleware, createCoupons);
 ...
 */
router.post('/post-user-coupons', autoMiddleware, createUserCoupons);
 ...
 */
router.put('/edit-coupons/:couponID', autoMiddleware, updateCoupons);
